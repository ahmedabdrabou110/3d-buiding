...
const Level = (room: any) => {
  ...
  return (
    <>
      ...
      >
        <svg
          className={`map map--${room.room.level}`}
          viewBox="0 0 792 612"
          width="100%"
          height="100%"
          ...
          <g className="level-g-borders">
            ...
            <g className="level-g-walls">
              <polyline
                ...
                points="266.43 59.43 243.6 59.43 243.6 13.77 277.4 13.77 277.4 59.43"
              />
              <polyline
                className="map__walls"
              ...
              <polyline
                className="map__walls"
                points="316.55 143.35 390.98 143.35 390.98 190.8"
              />
              <polyline
                className="map__walls"
                points="390.98 201.18 390.98 206.81 316.55 206.81 316.55 154.62"
              />
              <polyline
                className="map__walls"
              ...
              <polyline
                className="map__walls"
                points="393.05 201.77 393.05 206.81 512.26 206.81 512.26 201.77"
              />
              <line
                className="map__walls"
                x1="512.26"
              ...
              <polyline
                className="map__walls"
                points="524.12 150.47 535.09 150.47 535.09 140.38"
              />
              <polyline
                className="map__walls"
              ...
              <polyline
                className="map__walls"
                points="565.34 71.3 570.98 71.3 570.98 56.47 567.02 56.47"
              />
              <line
                className="map__walls"
                x1="555.85"
              ...
              <polyline
                className="map__walls"
                points="515.23 152.35 513.45 152.35 514.33 191.09"
              />
              <polyline
                className="map__walls"
                points="582.64 261.27 582.64 259.49 572.75 259.49"
              />
              <polyline
                className="map__walls"
                points="582.64 271.75 582.64 282.03 504.35 282.03 504.35 234.19"
              />
              <line
                className="map__walls"
                x1="487.75"
              ...
              <polyline
                className="map__walls"
                points="208.02 260.48 208.02 258.21 209.59 258.21"
              />
              <line
                className="map__walls"
                x1="227.19"
              ...
              <polyline
                className="map__walls"
                points="252.3 258.21 255.46 258.21 255.46 209.28 260.4 209.28"
              />
              <line
                className="map__walls"
                x1="270.68"
              ...
              <polyline
                className="map__walls"
                points="310.81 209.28 514.33 209.28 514.33 201.77"
              />
              <polyline
                className="map__walls"
                points="524.12 152.35 536.57 152.35 536.57 159.86"
              />
              <polyline
                className="map__walls"
                points="544.48 259.49 536.58 259.49 536.58 169.74"
              />
              <polyline
                className="map__walls"
              ...
              <polyline
                className="map__walls"
                points="592.72 246.44 587.18 246.44 587.18 224.7 595.09 224.7"
              />
              <polyline
                className="map__walls"
                points="608.73 224.7 617.03 224.7 617.03 246.44 613.67 246.44"
              />
              <polyline
                className="map__walls"
              ...
              <polyline
                className="map__walls"
                points="584.81 272.34 584.81 282.03 601.22 282.03"
              />
              <polyline
                className="map__walls"
              ...
              <polyline
                className="map__walls"
                points="688.79 385.42 647.87 385.42 646.88 382.85"
              />
              <polyline
                className="map__walls"
              ...
              <polyline
                className="map__walls"
                points="153.25 385.42 97.31 385.42 97.31 383.84"
              />
              <line
                className="map__walls"
                x1="165.51"
              ...
              <polyline
                className="map__walls"
                points="190.42 282.23 203.47 282.23 203.47 273.92"
              />
              <polyline
                className="map__walls"
                points="203.47 260.48 203.47 250.99 198.72 250.99"
              />
              <polyline
                className="map__walls"
                points="198.72 247.63 203.47 247.63 203.47 224.9 196.16 224.9"
              />
              <polyline
                className="map__walls"
                points="179.75 224.31 174.41 224.31 174.41 247.63 179.75 247.63"
              />
              <polyline
                className="map__walls"
              ...
              <polyline
                className="map__walls"
                points="240.83 174.09 252.3 174.09 252.3 256.53"
              />
              <polyline
                className="map__walls"
                points="229.27 174.09 208.81 174.09 208.81 256.53"
              />
              <line
                className="map__walls"
                x1="227.19"
              ...
              <polyline
                className="map__walls"
                points="307.65 335.61 326.63 335.61 326.63 349.05"
              />
              <polyline
                className="map__walls"
              ...
              <polyline
                className="map__walls"
                points="326.63 361.7 326.63 374.55 324.26 374.55"
              />
              <polyline
                className="map__walls"
              ...
              <polyline
                className="map__walls"
                points="434.77 400.84 485.77 400.84 485.77 386.8"
              />
              <polyline
                className="map__walls"
              ...
              <polyline
                className="map__walls"
                points="690.57 400.84 692.75 400.84 692.75 410.33"
              />
              <polyline
                className="map__walls"
              ...
              <polyline
                className="map__walls"
                points="603.99 385.42 586.39 385.42 586.39 288.16 601.22 288.16"
              />
              <rect
                className="map__walls"
                x="599.44"
              ...
              <polyline
                className="map__walls"
                points="538.35 238.34 557.13 238.34 557.13 257.62"
              />
              <polyline
                className="map__walls"
